# Level 3 – Google Service Account Impersonation

In this level I learned how Terraform can securely authenticate to Google Cloud
without storing or using any service account keys. Instead of using a JSON key,
I configured Terraform to impersonate a Google Service Account (GSA) using my own
Google identity.

I understood:
- why service account keys are unsafe
- how impersonation provides short-lived tokens
- how Terraform can adopt the identity of a GSA
- how IAM roles and permissions apply to the impersonated account
- how impersonation allows for secure, compliant infrastructure deployments

This is a fundamental security practice in enterprises and regulated
environments because it eliminates static secrets and provides fully auditable
access control.
